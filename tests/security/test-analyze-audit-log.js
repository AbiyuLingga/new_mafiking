...
//
// Run via `node tests/security/test-analyze-audit-log.js` or as part of
...
const result = spawnSync(process.execPath, [path.join(ROOT, 'scripts', 'security', 'analyze-audit-log.js')], { encoding: 'utf8' });
